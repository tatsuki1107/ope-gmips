...
ope_estimator_with_weight_estimation = {
    "stanadrd": MIPS(estimator_name=r"MSIPS-$\hat{w}$"),
    "independent": MIPS(estimator_name=r"MIIPS-$\hat{w}$"),
    "cascade": MIPS(estimator_name=r"MRIPS-$\hat{w}$"),
}
...
def main(cfg) -> None:
    ...
    ope_estimators.append(ope_estimator_with_weight_estimation[user_behavior])
    ...
    for val_size in cfg.variation.val_size_list:
        ...
        args = (ope_estimators[user_behavior], None, dataset, cfg.val_size, cfg.eps)
